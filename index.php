<?php
    $faq = [
        ...
        [
            ...
            <p>Puoi leggere ulteriori informazioni sulla sicurezza online, incluso come proteggere te e la tua famiglia online, nel <a href='#'>Centro Google per la sicurezza online</a>Centro Google per la sicurezza online.</p>
        ...
        [
            ...
            <ol style='list-style-type:lower-alpha'><li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell'Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
        ...
        <main>
            <div class="main-text container">
                <?php foreach($faq as $elm){ ?>
                    <h3><?php echo "{$elm['question']}";?></h3>
                    <?php echo "{$elm['answers']}";?>
                <?php } ?>
            </div>
        </main>
